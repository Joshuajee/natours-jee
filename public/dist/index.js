...
})({"ecVGG":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
if (signUpForm) signUpForm.addEventListener('submit', (e)=>{
    ...
    _auth.signUp(name, email, password, passwordConfirm);
});
...
const signUp = async (name, email, password, passwordConfirm)=>{
    ...
    try {
        ...
        if (res.data.status === 'success') {
            _alerts.showAlert('success', 'Account created successfully!');
            window.setTimeout(()=>{
                location.assign('/');
            }, 1500);
        }
...
const forgot = async (email)=>{
    try {
        ...
        if (res.data.status === 'success') _alerts.showAlert('success', 'Password Reset Sent!');
    } catch (err) {
        _alerts.showAlert('error', err.response.data.message);
    }
};

},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ecVGG","f2QDv"], "f2QDv", "parcelRequire11c7")
